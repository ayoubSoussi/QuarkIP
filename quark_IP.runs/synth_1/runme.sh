...
HD_PWD='/tp/xph3seo/xph3seo506/quark_IP/quark_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log quark_hash.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source quark_hash.tcl
